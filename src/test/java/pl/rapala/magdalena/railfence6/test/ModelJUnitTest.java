package pl.rapala.magdalena.railfence6.test;
...
public class ModelJUnitTest {
    ...
    /**
     * model is an instance of {@link pl.rapala.magdalena.railfence6.model.Model} class, whose public methods will be tested here.
     */
    private Model model;
    ...
    /**
     * testSetModeCorrect is a method that tests whether the method {@link pl.rapala.magdalena.railfence6.model.Model#setMode(java.lang.String)} method correctly converts the input mode into lowercase mode.
     * 
    ...
    /**
     * testSetModeIncorrect is a test method that tests the method {@link pl.rapala.magdalena.railfence6.model.Model#setMode(java.lang.String)} for incorrect option.
     * 
    ...
    /**
     * testSetTextCorrect is a test method that tests the method {@link pl.rapala.magdalena.railfence6.model.Model#setText(java.lang.String)}.
     * 
    ...
    /**
     * testSetTextIncorrect is a test method that tests the method {@link pl.rapala.magdalena.railfence6.model.Model#setText(java.lang.String)}.
     * 
    ...
    /**
     * testSetNoOfRailsCorrect is a test method that tests the method {@link pl.rapala.magdalena.railfence6.model.Model#setNoOfRails(int)}.
     * 
    ...
    /**
     * testSetNoOfRailsIncorrect is a test method that tests the method {@link pl.rapala.magdalena.railfence6.model.Model#setNoOfRails(int)}.
     * 
    ...
    public void testSetNoOfRailsIncorrect(String inputText, int inputRails)
    {
     ...
     /**
     * testSetNoOfRailsNoText is a test method that tests the method {@link pl.rapala.magdalena.railfence6.model.Model#setNoOfRails(int)}.
     * 
    ...
    /**
     * testRailFenceCorrect is a test method that tests the method {@link pl.rapala.magdalena.railfence6.model.Model#railFence()} and its later called methods for encryption and decryption called {@link pl.rapala.magdalena.railfence6.model.Model#encode()} and {@link pl.rapala.magdalena.railfence6.model.Model#decode()}.
     * 
    ...
    /**
     * testRailFenceCorrectHistory is a test method that tests the method {@link pl.rapala.magdalena.railfence6.model.Model#railFence()} and its later called methods for encryption and decryption called {@link pl.rapala.magdalena.railfence6.model.Model#encode()} and {@link pl.rapala.magdalena.railfence6.model.Model#decode()}.
     * 
     * @param mode the correct mode (Encoding, Decoding) for the cipher.
     * @param inputText the correct input text.
     * @param inputRails the correct number of rails.
    ...
    @ParameterizedTest
    @CsvSource({"en,Ala ma kota,2,Aam oal akt","en,Ala ma kota,1,Ala ma kota","de,Aam oal akt,2,Ala ma kota","de,Aam oal akt,1,Aam oal akt", "en,okay,2,oaky", "de,oaky,2,okay", "en,ok,2,ok", "de,ok,2,ok", "en,a,1,a", "de,a,1,a"})
    public void testRailFenceCorrectHistory(String mode, String inputText, int inputRails, String expectedResult){
        ...
        try{
            ...
            assertEquals(model.getActionHistory().getFirst(), cipherEntry, "The records should equal. Correct");
        }catch(IllegalArgumentException | IncorrectNoOfRailsException e)
        {
            fail("The cipher history collection failed.");
        }

    }
    
    /**
     * testRailFenceIncorrect is a test method that tests the method {@link pl.rapala.magdalena.railfence6.model.Model#railFence()} and its later called methods for encryption and decryption called {@link pl.rapala.magdalena.railfence6.model.Model#encode()} and {@link pl.rapala.magdalena.railfence6.model.Model#decode()}.
     * 
     * @param mode the correct mode (Encoding, Decoding) for the cipher.
     * @param inputText the correct input text.
     * @param inputRails the correct number of rails.
    ...
    /**
     * testRailFenceNoMode is a test method that tests the method {@link pl.rapala.magdalena.railfence6.model.Model#railFence()} without mode set.
     * 
     * @param inputText the correct input text.
    ...
    /**
     * testRailFenceNoModeOneRail is a test method that tests the method {@link pl.rapala.magdalena.railfence6.model.Model#railFence()} without mode set, but with one rail.
     * 
    ...
    /**
     * testRailFenceNoRails is a test method that tests the method {@link pl.rapala.magdalena.railfence6.model.Model#railFence()} without rails set.
     * 
