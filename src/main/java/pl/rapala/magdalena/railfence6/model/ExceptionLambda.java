...
* 
* @param <V> type of exception to be returned and thrown;  here used for RuntimeException (IllegalArgumentException) and {@link pl.rapala.magdalena.railfence6.model.IncorrectNoOfRailsException} custom exception (which extends Exception).
* @param <E> thrown exception constraint, allowing any Exception subclass. Since {@link pl.rapala.magdalena.railfence6.model.IncorrectNoOfRailsException} extends Exception, which is a checked exception, compiler requires to declare the throw.
